...
import FormulationOverview from "./formulation/FormulationOverview";
import SOP1MCTOil from "./formulation/SOP1MCTOil";
import SOP2PGInhalation from "./formulation/SOP2PGInhalation";
import SOP3Concentrate from "./formulation/SOP3Concentrate";
import { downloadPDF, getPDFForFormulationType } from "@/utils/pdfUtils";

const FormulationGuide: React.FC = () => {
...
export default FormulationGuide;
