...
export const translations: TranslationsData = {
  de: {
    ...
    'register.description': 'Registrieren Sie Ihre Apotheke für den Zugang zu unseren Produkten',
    'register.firstName': 'Vorname',
    'register.lastName': 'Nachname',
    'register.email': 'E-Mail',
    'register.emailPlaceholder': 'apotheke@beispiel.de',
    'register.emailHint': 'Bitte verwenden Sie Ihre geschäftliche E-Mail-Adresse',
    'register.password': 'Passwort',
    'register.confirmPassword': 'Passwort bestätigen',
    'register.role': 'Ihre Rolle',
    'register.rolePlaceholder': 'Wählen Sie Ihre Rolle',
    'register.pharmacist': 'Apotheker',
    'register.doctor': 'Arzt',
    'register.button': 'Registrieren',
    'register.processing': 'Verarbeitung...',
    'register.alert': 'Nur für medizinisches Fachpersonal und Apotheken zugänglich. Bitte registrieren Sie sich mit Ihren beruflichen Daten.',
    ...
    'features.cta.register': 'Als Apotheke registrieren',
    ...
    'aboutUs.supplyChain.production': 'Produktion',
    'aboutUs.supplyChain.production.desc': 'Sorgfältige Auswahl von Premium-Cannabisproduzenten mit höchsten Qualitätsstandards',
    'aboutUs.supplyChain.quality': 'Qualitätskontrolle',
    'aboutUs.supplyChain.quality.desc': 'Jedes Produkt durchläuft strenge Qualitätsprüfungen',
    'aboutUs.supplyChain.delivery': 'Lieferung',
    'aboutUs.supplyChain.delivery.desc': 'Sichere und schnelle Lieferung an Apotheken in ganz Deutschland',
    ...
    'aboutUs.story.cta': 'Kontaktieren Sie uns',
  ...
  en: {
    ...
    'register.description': 'Register your pharmacy for access to our products',
    'register.firstName': 'First Name',
    'register.lastName': 'Last Name',
    'register.email': 'Email',
    'register.emailPlaceholder': 'pharmacy@example.com',
    'register.emailHint': 'Please use your business email address',
    ...
    'register.alert': 'Only accessible to medical professionals and pharmacies. Please register with your professional details.',
    ...
    'features.cta.register': 'Register as Pharmacy',
    ...
    'aboutUs.supplyChain.production': 'Production',
    'aboutUs.supplyChain.production.desc': 'Careful selection of premium cannabis producers with the highest quality standards',
    'aboutUs.supplyChain.quality': 'Quality Control',
    'aboutUs.supplyChain.quality.desc': 'Every product undergoes rigorous quality checks',
    'aboutUs.supplyChain.delivery': 'Delivery',
    'aboutUs.supplyChain.delivery.desc': 'Secure and fast delivery to pharmacies throughout Germany',
    ...
    'aboutUs.terpenes.entourage.desc': 'Our expertise lies in understanding the "entourage effect" – how cannabinoids and terpene work together to enhance therapeutic effects. Through careful analysis and selection, we offer products with optimal terpene profiles for various medical applications.',
